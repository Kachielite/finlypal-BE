...
public class JwtAuthEntryPoint implements AuthenticationEntryPoint {
  ...
  /**
   * This method is invoked when the user is not authenticated and tries to access a protected
   * resource. It sends a 403 Forbidden response to the user with a JSON body containing the error
   * message.
   *
