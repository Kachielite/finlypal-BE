...
public class ExpenseServiceImpl implements ExpenseService {
    ...
    public ExpenseResponseDTO addExpense(ExpenseRequestDTO expenseRequestDTO)
        ...
        try {
            ...
            BudgetItem budgetItem = budgetItemRepository.findById(expenseRequestDTO.budgetItemID()).orElseThrow(
                    () -> new BadRequestException("Could not find budget item with id: " + expenseRequestDTO.budgetItemID())
            );
