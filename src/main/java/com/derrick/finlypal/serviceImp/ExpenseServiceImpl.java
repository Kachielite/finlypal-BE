...
public class ExpenseServiceImpl implements ExpenseService {
    ...
    /**
     * This method is used to find all expenses associated with the currently logged in user based
     * on the given criteria. It can be used to find expenses by type, date range and category id.
     * If the start date is provided but the end date is not, it throws a {@link BadRequestException}.
     * If the end date is provided but the start date is not, it throws a {@link BadRequestException}.
     * If the start date is after the end date, it throws a {@link BadRequestException}. If any
     ...
     */
    @Override
    public Page<ExpenseResponseDTO> findAllByUserIdAndDateBetweenOrTypeOrCategoryId(
            ExpenseType expenseType, LocalDate startDate, LocalDate endDate, Long categoryId, int page, int pageSize
    ) throws InternalServerErrorException, BadRequestException {
        log.info("Received request to find expenses with type {}, date between {} and {}, category id {}", expenseType, startDate, endDate, categoryId);
        try {
            ...
            Page<Expense> expenses = expenseRepository.findAllByUserIdAndDateBetweenOrTypeOrCategoryId(userId, startDate, endDate, expenseType, categoryId, pageable);
