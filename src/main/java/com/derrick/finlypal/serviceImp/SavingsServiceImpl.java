...
public class SavingsServiceImpl implements SavingsService {
    ...
    /**
     * Creates a new savings goal for the logged-in user. It validates the provided savings
     * details, such as ensuring the start date is before the end date and that both dates are
     * not in the past. If the savings details are valid, it calculates the savings status and
     * saves the savings to the repository. Returns a SavingsResponseDTO containing the savings
     * details.
     *
    ...
    /**
     * Retrieves a savings goal by its id. It first checks if the logged-in user is authorized to
     * read the savings goal. If the user is not authorized, it throws a {@link
     * NotAuthorizedException}. If the savings goal with the given id is not found, it throws a
     * {@link NotFoundException}. If any unexpected error occurs while trying to retrieve the
     ...
     * and saved amount for each savings goal, and returns them as a page of {@link SavingsResponseDTO}.
     * It ensures that the user is authenticated and handles any unexpected errors during the process.
     *
     ...
     * @throws InternalServerErrorException if any unexpected error occurs while retrieving the savings goals
     */
    @Override
     ...
     *
     * <p>This method validates the request by ensuring that the user is authenticated and authorized to delete the
     * savings goal. It then deletes the savings goal from the repository and returns a {@link GeneralResponseDTO}
     * indicating the status of the request. If the request is invalid, it throws a {@link BadRequestException}. If the
     * user is not authorized to delete the savings goal, it throws a {@link NotAuthorizedException}. If any unexpected
     * error occurs while deleting the savings goal, it throws an {@link InternalServerErrorException}.
     *
     ...
     * @throws InternalServerErrorException if any unexpected error occurs while deleting the savings goal
     */
    @Override
