...
public class BudgetItemServiceImpl implements BudgetItemService {
     ...
     * <p>
     * This method takes a list of {@link BudgetItemCreateRequestDTO} and a budget ID. It checks if the
     * current user is authorized to create items for the specified budget. If authorized, it creates
     * and saves the budget items in the repository. If the budget is not found, or the user is not
     * authorized, or no budget items are provided, it throws the respective exceptions.
     *
     ...
     * @throws NotAuthorizedException       if the user is not authorized to create budget items for the budget
     */
    @Transactional
    @Override
     ...
     * @throws InternalServerErrorException if any unexpected error occurs while trying to get the budget
     *                                      items
     * @throws NotFoundException            if the budget with the given id is not found
    ...
    /**
     * This method is used to get a budget item by its id. It returns a {@link BudgetItemResponseDTO} if
     * the budget item is found, otherwise it throws a {@link NotFoundException}. It also checks if the
     * user is authorized to view the budget item by comparing the user id of the budget item and the
     * logged in user. If the user is not authorized, it throws a {@link NotAuthorizedException}. If any
     * unexpected error occurs while trying to get the budget item, it throws an {@link
     * InternalServerErrorException}.
     *
     ...
     * the id of the budget item to be updated and the {@link BudgetItemUpdateRequestDTO} containing the
     * new values. It returns a {@link BudgetItemResponseDTO} indicating the status of the request. If
     * the request is successful, it returns a status of {@link HttpStatus#OK} and a message indicating
     * that the budget item was successfully updated. If the budget item with the given id is not found,
     * it throws a {@link NotFoundException}. If the user is not authorized to update the budget item, it
     * throws a {@link NotAuthorizedException}. If any unexpected error occurs while trying to update
     * the budget item, it throws an {@link InternalServerErrorException}.
     *
    ...
    /**
     * Deletes a budget item with the given id. It takes in the id of the budget item to be deleted and
     * returns a {@link GeneralResponseDTO} indicating the status of the request. If the budget item with
     * the given id is not found, it throws a {@link NotFoundException}. If the user is not authorized to
     * delete the budget item, it throws a {@link NotAuthorizedException}. If any unexpected error
     * occurs while trying to delete the budget item, it throws an {@link InternalServerErrorException}.
     *
     ...
     * <ul>
     *   <li>If the actual spend is greater than the allocated amount, the status is {@link BudgetItemStatus#OVERSPENT}.</li>
     *   <li>If the actual spend is less than the allocated amount, the status is {@link BudgetItemStatus#UNDERSPENT}.</li>
     *   <li>If the actual spend is equal to the allocated amount, the status is {@link BudgetItemStatus#ON_TRACK}.</li>
     * </ul>
     *
     ...
     * <p>
     * This method retrieves all expenses associated with the given user ID and budget item ID,
    ...
    /**
     * Retrieves all expenses associated with a specific user ID and budget item ID, and
     * converts them to a list of {@link ExpenseResponseDTO}.
     *
