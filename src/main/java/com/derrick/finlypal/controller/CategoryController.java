...
public class CategoryController {
    ...
    @Operation(
            ...
            description = "Fetch the details of a specific category using its unique identifier (category_id). This operation returns the category's name, description, and display name if found."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
