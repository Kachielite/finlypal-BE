...
@Tag(
    name = "Savings",
    description =
        "Endpoints for managing savings goals, including creation, update, retrieval, and deletion of savings records. These APIs allow users to set financial goals and track their savings progress over time.")
public class SavingsController {
  ...
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "Savings goal deleted successfully"),
    @ApiResponse(
        responseCode = "404",
        description = "Savings goal not found",
        content = @Content(schema = @Schema(implementation = ErrorResponseDTO.class))),
