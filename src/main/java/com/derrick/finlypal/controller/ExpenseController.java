...
public class ExpenseController {
    ...
    public ResponseEntity<Page<ExpenseResponseDTO>> getAllExpenses(
        ...
        return new ResponseEntity<>(expenseService.findAllByUserIdAndDateBetweenOrTypeOrCategoryId(type, start_date, end_date, category_id, page, pageSize), HttpStatus.OK);
    }
